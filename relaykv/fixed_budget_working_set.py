...
def _ceil_blocks(tokens: int, block_size: int) -> int:
    if tokens <= 0:
        return 0
    ...
    *,
    ...
    class_budgets = {
        name: RelayKVClassBudget(
            ...
            budget_blocks=_ceil_blocks(budgets[name], config.block_size),
            source=sources[name],
        )
    ...
    selected_block_plan = {
        ...
        "estimated_physical_working_tokens": estimated_physical_tokens,
